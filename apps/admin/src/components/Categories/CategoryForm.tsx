...
import { Category, CategoryFormValues } from "@nextjs-ecommerce/db/src/types";
...
import { categoryFormSchema } from "@nextjs-ecommerce/db/src/schemas";
...
export const CategoryForm = ({ initialData, onSubmit }: CategoryFormProps) => {
  ...
  const form = useForm<CategoryFormValues>({
    resolver: zodResolver(categoryFormSchema(!!initialData)),
    defaultValues: {
  ...
  const { isChecking } = useFieldValidation(
    "categories",
    "name",
    form,
    initialData?.id
